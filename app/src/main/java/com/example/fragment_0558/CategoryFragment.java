package com.example.fragment_0558;
...
public class CategoryFragment extends Fragment implements View.OnClickListener  {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_sub_category) {
            SubCategoryFragment mDetailCategoryFragment = new SubCategoryFragment();
        ...
        */
            ...
            if (mFragmentManager != null) {
                mFragmentManager
                        .beginTransaction()
                        .replace(R.id.frame_container, mDetailCategoryFragment, SubCategoryFragment.class.getSimpleName())
                        .addToBackStack(null)
                        .commit();
            }
        }
